...
namespace GameEngine
{
    internal class AudioClipLoader : AssetLoader
    {
        ...
        public override void UnloadAsset(object asset)
        {
            ...
            openAL.DeleteBuffer(audioClip.buffer);
            Console.WriteLine("" + audioClip);
        }

        unsafe AudioClip LoadBuffer(string filePath)
        {
            ...
            while (index + 4 < file.Length)
            {
                ...
                else if (identifier == "data")
                {
                    ...
                    fixed (byte* pData = data)
                        openAL.BufferData(buffer, format, pData, size, sampleRate);
